...
<body>
        ...
        <tbody>
            ...
            if ($stmt->rowCount() > 0) {
                ...
                while ($row = $stmt->fetch()) {
                    ...
                    echo "<td><a href='php11G.php?slot=", $row["slot"], "'><img src='edit.png'></a></td>";
                    echo "<td><a href='php11H.php?slot=", $row["slot"], "'><img src='remove.png'></a></td>";
                    echo "</tr>";
                }
            }
    ...
    <form action="php11E.php" method="post">
